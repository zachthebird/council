...
export { getAdapter, listAdapters, register, registerExternalAdapter } from '../adapters/registry.mjs';
export { loadExternalAdapter, externalParseEvents, EXTERNAL_PROTOCOL_VERSION } from '../adapters/external.mjs';
